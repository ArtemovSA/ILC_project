...
PmReturn_t
nat_18_dict_clear(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_19_dict_keys(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_20_dict_values(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_21_func_co_names(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_22_func_co_consts(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_23_string_atoi(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_24_string_count(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_25_string_find(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_26_list_append(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_27_list_index(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_28_list_insert(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_29_list_pop(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_30_list_remove(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_31_sizeof_sizeof(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_32_sys_exit(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_33_sys_gc(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_34_sys_getb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_35_sys_heap(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_36_sys_putb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_37_sys_runInThread(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_38_sys_time(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_39_sizeof_sizeof(pPmFrame_t *ppframe)
{
...
pPmNativeFxn_t const std_nat_fxn_table[] =
{
    ...
    nat_19_dict_keys,
    nat_20_dict_values,
    nat_21_func_co_names,
    nat_22_func_co_consts,
    nat_23_string_atoi,
    nat_24_string_count,
    nat_25_string_find,
    nat_26_list_append,
    ...
    nat_29_list_pop,
    nat_30_list_remove,
    nat_31_sizeof_sizeof,
    nat_32_sys_exit,
    nat_33_sys_gc,
    nat_34_sys_getb,
    nat_35_sys_heap,
    nat_36_sys_putb,
    nat_37_sys_runInThread,
    nat_38_sys_time,
    nat_39_sizeof_sizeof,
};
