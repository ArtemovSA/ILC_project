...
//      if (py_task == PY_SCRIPT_STOP)      //Выйти из задачи
//        break;
//      
//      while (py_task == PY_SCRIPT_PAUSE); //Поставить задачу на паузу
...
interp_reschedule(void)
{
    ...
    //Добавить поток из очереди callback
//    int id;
//    if ( ( id = py_get_callbackID() ) != -1 ) {
//      interp_addThread((pPmFunc_t)py_callback[id].py_func);
//    }
