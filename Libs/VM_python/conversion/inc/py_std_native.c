...
PmReturn_t
nat_00_dict_clear(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_01_dict_keys(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_02_dict_values(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_03_func_co_names(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_04_func_co_consts(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_05_ipm__getImg(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_06_ipm_x04(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_07_list_append(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_08_list_index(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_09_list_insert(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_10_list_pop(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_11_list_remove(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_12_sizeof_sizeof(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_13_string_atoi(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_14_string_count(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_15_string_find(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_16_sys_exit(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_17_sys_gc(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_18_sys_getb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_19_sys_heap(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_20_sys_putb(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_21_sys_runInThread(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_22_sys_time(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_23___bi_chr(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_24___bi_dir(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_25___bi_eval(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_26___bi_globals(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_27___bi_id(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_28___bi_len(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_29___bi_locals(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_30___bi_ord(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_31___bi_range(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_32___bi_sum(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_33___bi_type(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_34___bi_Co(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_35___bi___init__(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_36___bi_send(pPmFrame_t *ppframe)
{
...
PmReturn_t
nat_37___bi_ismain(pPmFrame_t *ppframe)
{
...
pPmNativeFxn_t const std_nat_fxn_table[] =
{
    ...
    nat_01_dict_keys,
    nat_02_dict_values,
    nat_03_func_co_names,
    nat_04_func_co_consts,
    nat_05_ipm__getImg,
    nat_06_ipm_x04,
    nat_07_list_append,
    nat_08_list_index,
