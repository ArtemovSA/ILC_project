...
#define Const_MaxComNum     2               // 以下为对应的buf序号，如果三个共用一个buf，则全部为0，如果分开，则根据实际分开
#define ComIndex_Uart2      1               //  红外
#define ComIndex_Uart3      0               //  485
#define ComIndex_Uart4      3               //   
//端口
#define Const_MaxPortNum    2               // 总的端口数
#define Port_Uart2          1               //
#define Port_Uart3          0               //
#define Port_Uart4          3               // 端口与COM的对应关系
