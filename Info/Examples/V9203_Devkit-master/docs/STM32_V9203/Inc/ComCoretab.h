...
extern const   S_CORETAB  gs_CoreTab0[];
extern const   S_CORETAB  gs_CoreTab2[];
extern const   S_CORETAB  gs_CoreTab3[];
extern const   S_CORETAB  gs_CoreTab4[];
...
extern const   S_COREID  gs_CoreID[];         //核心数据表与ID的对应关系
extern const   uint8  NumofCoreID;

/*******************************************************************************
**定义特殊处理函数的数据结构
*******************************************************************************/
typedef uint8 (*PFUNC)(S_FRAMEINFO*, S_CORETAB * );

extern const PFUNC  FunList[];
