...
#define LCD_Duty_1_8                    ((uint32_t)0x00000010) /*!< 1/8 duty    */
...
#define LCD_PulseOnDuration_1           ((uint32_t)0x00000010) /*!< Pulse on duration = 1/LCD_PS  */
#define LCD_PulseOnDuration_2           ((uint32_t)0x00000020) /*!< Pulse on duration = 2/LCD_PS  */
#define LCD_PulseOnDuration_3           ((uint32_t)0x00000030) /*!< Pulse on duration = 3/LCD_PS  */
#define LCD_PulseOnDuration_4           ((uint32_t)0x00000040) /*!< Pulse on duration = 4/LCD_PS  */
#define LCD_PulseOnDuration_5           ((uint32_t)0x00000050) /*!< Pulse on duration = 5/LCD_PS  */
#define LCD_PulseOnDuration_6           ((uint32_t)0x00000060) /*!< Pulse on duration = 6/LCD_PS  */
#define LCD_PulseOnDuration_7           ((uint32_t)0x00000070) /*!< Pulse on duration = 7/LCD_PS  */
...
#define LCD_BlinkMode_SEG0_AllCOM       ((uint32_t)0x00020000) /*!< Blink enabled on SEG[0], all COM (up to 8 pixels according to the programmed duty)     */
...
#define LCD_Contrast_2V6                ((uint32_t)0x00000000) /*!< Maximum Voltage = 2.60V    */
#define LCD_Contrast_2V7                ((uint32_t)0x00000400) /*!< Maximum Voltage = 2.70V    */
#define LCD_Contrast_2V8                ((uint32_t)0x00000800) /*!< Maximum Voltage = 2.80V    */
#define LCD_Contrast_2V9                ((uint32_t)0x00000C00) /*!< Maximum Voltage = 2.90V    */
#define LCD_Contrast_3V0                ((uint32_t)0x00001000) /*!< Maximum Voltage = 3.00V    */
#define LCD_Contrast_3V1                ((uint32_t)0x00001400) /*!< Maximum Voltage = 3.10V    */
#define LCD_Contrast_3V2                ((uint32_t)0x00001800) /*!< Maximum Voltage = 3.20V    */
#define LCD_Contrast_3V3                ((uint32_t)0x00001C00) /*!< Maximum Voltage = 3.30V    */
