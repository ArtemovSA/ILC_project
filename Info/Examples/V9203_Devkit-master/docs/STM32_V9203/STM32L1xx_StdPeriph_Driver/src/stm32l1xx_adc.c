...
/**
  ...
  *   that contains the configuration information for ADC1 peripheral.
  * @retval None
  */
void ADC_CommonInit(ADC_CommonInitTypeDef* ADC_CommonInitStruct)                           
{
  ...
  /* Configure ADCx: ADC prescaler accrording to ADC_Prescaler */                
  tmpreg1 |= (uint32_t)(ADC_CommonInitStruct->ADC_Prescaler);        
...
/**
  * @brief  Enables or disables the ADC Power Down during Delay and/or 
  *         Idle phase.
  * @param  ADCx: where x can be 1 to select the ADC1 peripheral.
  * @param  ADC_PowerDown: The ADC power down configuration. This parameter 
  *    can be one of the following values:
  *     @arg ADC_PowerDown_Delay : ADC is powered up during delay phase  
  *     @arg ADC_PowerDown_Idle : ADC is powerd up during Idle phase 
  *     @arg ADC_PowerDown_Idle_Delay : ADC is powerd up during Delay 
  *                                    and Idle phase 
  * @param  NewState: new state of the ADCx power down. This parameter
  *         can be: ENABLE or DISABLE.
  * @retval None
  */
void ADC_PowerDownCmd(ADC_TypeDef* ADCx, uint32_t ADC_PowerDown, FunctionalState NewState)
{
  ...
  {
    /* Disbale The ADC power-down during Delay and/or Idle phase */
...
/**
  ...
  *         on regular group channel. This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  ...
  *   selected channel. This parameter can be one of the following values:
...
/**
  ...
  * @param  ADCx: where x can be 1 to select the ADC1 peripheral.
  * @param  ADC_DelayLength: The length of delay which is applied after a conversion 
  *   or a sequence of conversion. This parameter can be one of the following values:
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg ADC_ExternalTrigConvEdge_None: external trigger 
  ...
  *     @arg ADC_External ADC_ExternalTrigConvEdge_RisingFalling: 
