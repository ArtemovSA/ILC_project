...
const PFUNC  FunList[] = 
{
    ...
    FunToBeDef,//FFTCalc,  //ReadZHLYEgy,                    //0x0F 读取组合累用电量
    ...
    FunToBeDef, //RTHZjl,                         //0x18读取跳合闸记录块
    ReadCurNEgy                 //0x19 读取当前的无功电量
};
//下面的数据标识必须从小到大排列
...
//  {0x000D0001,    0,  4,  0,  6,  0x02,   0,              0x11,}, // 历史年度组合有功总累计用电量
    ...
    {0x002b0000,    0,  4,  4,  0,  0x19,   0,             BPhy,}, //（当前）B向组合无功总电能
    {0x002c0001,    0,  4,  4,  11, 0x19,   0,              0,}, //  B向组合无功总电能2

    {0x003D0000,    0,  4,  4,  0,  0x03,   0,             CPhy,}, //（当前）C正向有功总电能
    {0x003D0001,    0,  4,  4,  11, 0x03,   0,              0,}, //  历史  C正向有功总电能

    {0x003f0000,    0,  4,  4,  0,  0x19,   0,             CPhy,}, //（当前）c向组合无功总电能
    {0x00400001,    0,  4,  4,  11, 0x19,   0,              0,}, // c向组合无功总电能2
...
//  ID              Atb         LEN D1  D0      FUNID   ADDR
    ...
    //{0x020A0000,  Data_BCD,     1,  0,  0,      0x0F,   0,      0,      }, //谐波触发
    {0x020A0101,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      }, //A相电压谐波
    {0x020A01FF,  Data_BCD,     30, 0,  0,      0x07,   0,      0,      }, //A相电压谐波
    {0x020A0201,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      },//B相电压谐波
    {0x020A02FF,  Data_BCD,     30, 0,  0,      0x07,   0,      0,      }, //B相电压谐波
    {0x020A0301,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      },//C相电压谐波
    {0x020A03FF,  Data_BCD,     30, 0,  0,      0x07,   0,      0,      }, //C相电压谐波
 
    {0x020B0101,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      }, //A相电流谐波
    {0x020B0201,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      },//B相电流谐波
    {0x020B0301,  Data_BCD,     2,  0,  14,     0x07,   0,      0,      },//C相电流谐波
    
    {0x02800001,  Data_BCD,     3,  0,  0,      0x10,   0,      4,      },//零线电流
    {0x02800002,  Data_BCD,     2,  0,  0,      0x10,   0,      12,     },//电网频率
                                                                          //
    {0x02800007,  Data_BCD,     2,  0,  0,      0x10,   0,      21,     },//表内温度
...
*/
    {0x03A00001, Data_RO,               200, 5,  13,  0x02,   0,         EEP_ZBUA_PT,     },//周波
};
...
//    {0x04800004,    Data_Factor,            8,      0,  0,  0x05,   EEP_SWBAKNUM,           0,      },//软件备案号
    {0x0405AA00,    0,                      1,      0,  0,  0x05,   EEP_ZBCNT_PT,             0,      },//周波点数
};
...
* @修改内容: 
===========================================================================================*/
const   S_COREID  gs_CoreID[] =       //核心数据表与ID的对应关系
{
    {0x00,  (S_CORETAB *)gs_CoreTab0, sizeof(gs_CoreTab0) / sizeof(S_CORETAB)},
    {0x02,  (S_CORETAB *)gs_CoreTab2, sizeof(gs_CoreTab2) / sizeof(S_CORETAB)},
    {0x03,  (S_CORETAB *)gs_CoreTab3, sizeof(gs_CoreTab3) / sizeof(S_CORETAB)},
    {0x04,  (S_CORETAB *)gs_CoreTab4, sizeof(gs_CoreTab4) / sizeof(S_CORETAB)},
  //  {0x05,  (S_CORETAB *)gs_CoreTab5, sizeof(gs_CoreTab5) / sizeof(S_CORETAB)},
   // {0x06,  (S_CORETAB *)gs_CoreTab6, sizeof(gs_CoreTab6) / sizeof(S_CORETAB)},
   // {0x1D,  (S_CORETAB *)gs_CoreTab1D, sizeof(gs_CoreTab1D) / sizeof(S_CORETAB)},
    //{0x1E,  (S_CORETAB *)gs_CoreTab1E, sizeof(gs_CoreTab1E) / sizeof(S_CORETAB)},
    {0x4F,  (S_CORETAB *)gs_CoreTab4F, sizeof(gs_CoreTab4F) / sizeof(S_CORETAB)},
};

const   uint8  NumofCoreID = sizeof(gs_CoreID) / sizeof(S_COREID);
