...
//void Delay_Unit5us(void) 
//{ 
//   uint8 i=2; //这里可以优化速度 ，经测试最低到5还能写入 
//   while(i)  
//   {  
//     i--;  
//   }  
//}
//#define Delay_Unit5us() {nop();nop();nop();nop();nop();nop();nop();nop();nop();nop();nop();}
/*=========================================================================================\n
